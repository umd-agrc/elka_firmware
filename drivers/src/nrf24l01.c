...
#define RADIO_GPIO_CS             GPIO_Pin_8
#define RADIO_GPIO_CS_PORT        GPIOC
#define RADIO_GPIO_CS_PERIF       RCC_AHB1Periph_GPIOC


#define RADIO_GPIO_CE             GPIO_Pin_7
#define RADIO_GPIO_CE_PORT        GPIOC
#define RADIO_GPIO_CE_PERIF       RCC_AHB1Periph_GPIOC

#define RADIO_GPIO_IRQ            GPIO_Pin_6
#define RADIO_GPIO_IRQ_PORT       GPIOC
#define RADIO_GPIO_IRQ_PERIF      RCC_AHB1Periph_GPIOC
#define RADIO_GPIO_IRQ_SRC_PORT   EXTI_PortSourceGPIOC
#define RADIO_GPIO_IRQ_SRC        EXTI_PinSource6
...
void nrfInit(void)
{
  ...
  RCC_AHB1PeriphClockCmd(RADIO_GPIO_SPI_CLK | RADIO_GPIO_CS_PERIF |
                         RADIO_GPIO_CE_PERIF | RADIO_GPIO_IRQ_PERIF, ENABLE);

  /* Enable SPI and GPIO clocks */
  RCC_APB1PeriphClockCmd(RADIO_SPI_CLK, ENABLE);
  /*Enable SYSCFG clock for interrupt */
  ...
  /* SPI configuration */
  SPI_InitStructure.SPI_Direction = SPI_Direction_2Lines_FullDuplex; // separate MISO and MOSI lines
  ...
  SPI_InitStructure.SPI_NSS = SPI_NSS_Soft; //non slave select. set the NSS management to internal
  SPI_InitStructure.SPI_BaudRatePrescaler = SPI_BaudRatePrescaler_8; //SPI frequency is APB2 frequency /4
