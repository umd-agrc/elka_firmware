...
#define MOTORS_PWM_BITS     16//9
#define MOTORS_PWM_PERIOD   2000//((1<<MOTORS_PWM_BITS) - 1)
#define MOTORS_PWM_PRESCALE 80//0
...
#define MOTOR_LEFTFRONT  0
#define MOTOR_LEFTREAR  1
#define MOTOR_RIGHTFRONT 2
#define MOTOR_RIGHTREAR 3

#define MOTOR_LEFTMOTOR  0
#define MOTOR_RIGHTMOTOR  1
#define MOTOR_LEFTSERVO 2
#define MOTOR_RIGHTSERVO 3
#define MOTOR_TAIL 4


// Test defines
#define MOTORS_TEST_RATIO         (uint16_t)(0.5*(1<<16))
#define MOTORS_TEST_ON_TIME       10
#define MOTORS_TEST_DELAY_TIME    50
